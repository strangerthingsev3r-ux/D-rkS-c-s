...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "**Join My Discord Server : https://discord.gg/yjeEUQPmCy ", // required by Discord API, not shown in the client
        state: "Made By Odys",     // this is what people actually see
        type: 1,               // Custom
      },
    ],
  },
